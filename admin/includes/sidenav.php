        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="blogs.php" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i>Issues Raised</a>
                    </li>
                    <li>
                        <a href="about.php" class="waves-effect"><i class="fa fa-graduation-cap fa-fw" aria-hidden="true"></i>About</a>
                    </li>
                    <li>
                        <a href="contact.php" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i>New Queries</a>
                    </li>
                    <li>
                        <a href="admin.php" class="waves-effect"><i class="fa fa-book fa-fw" aria-hidden="true"></i>Manage Admin</a>
                    </li>

                    <li>
                        <a href="logout.php" class="waves-effect"><i class="fa fa-book fa-fw" aria-hidden="true"></i>Logout</a>
                    </li>
