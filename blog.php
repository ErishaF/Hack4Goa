                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Issues Raised</li>
                        </ol>
                    </div><!-- end col -->                    
                </div><!-- end row -->
            </div><!-- end container -->
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-custom-build">
                                ...
                                $blg = mysqli_query($conn, "SELECT * FROM `blogs` WHERE `status` = '1'");
                                ...
                                <div class="blog-box wow fadeIn">
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <p style="display:inline-block;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width: 60ch;"><?php echo
                                        base64_decode($rww['description']);?></p>
