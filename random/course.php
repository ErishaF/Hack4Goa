                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="" style="text-align: center">
                                <input type="text" name="course" placeholder="Add New Course" style="width: 200px; height: 30px; padding-left: 30px">
                                <input class="btn btn-info btn-md" type="submit" name="submit" value="Add New Course" style="margin-left: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
